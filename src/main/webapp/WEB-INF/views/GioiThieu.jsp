	...
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
			...
			<body>
				...
				<!-- NỌI DUNG GIỚI THIỆU   -->
				<div>
					<h1 style="font-size: 40px; margin: 30px 0px; color: black; text-align: center;">Về
						thương hiệu thời trang nam 360®</h1>
					<div style="display: flex; justify-content: center;">
						<img style="width: 80%;" alt="anh" src="/assets/img/bosuutap/gioithieu1.jpg">
					</div>
					<p style="text-align: justify-content; font-size: 16px; margin: 20px 0px; padding: 0px 153px;">
					...
					<div style="display: flex; justify-content: center;">
						<img style="width: 80%;" alt="anh" src="/assets/img/bosuutap/gioithieu2.jpg">
					</div>
					<p style="text-align: justify-content; font-size: 16px; margin: 20px 0px; padding: 0px 153px;">
					...
					<p style="text-align: justify-content; font-size: 16px; margin: 20px 0px; padding: 0px 153px;">
						Chúng ta chỉ thực sự thay đổi khi chúng ta hành động. 360 tin rằng dù có thể thành công hay thất
						bại, nhưng chắc chắn chỉ có những trải nghiệm mới giúp bạn trưởng thành. Trưởng thành là một
						hành trình với những dấu mốc thanh xuân, để khi nhìn lại tôi và bạn có thể tự tin không phải
						nuối tiếc “giá như…”</p>
