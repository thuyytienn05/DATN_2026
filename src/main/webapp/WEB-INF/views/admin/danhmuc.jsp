	...
	<div class="d-flex flex-column flex-root">
		<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="aside-menu flex-column-fluid ">
					<div class="hover-scroll-overlay-y px-2 my-5 my-lg-5"
						...
						<div
							...
							<div class="menu-item">
								<a class="menu-link active" href="/admin/danhmuc"> <span
									class="menu-icon"> <span class="svg-icon svg-icon-2">
			...
			<div class="wrapper d-flex flex-column flex-row-fluid"
					...
					<div class="toolbar" style="background: linear-gradient(135deg, #1e40af, #1e3a8a);">
						<div 
							...
							<div class="page-title d-flex flex-column me-5">
								<h1 class="d-flex flex-column fw-bolder fs-3 mb-0 text-white">QUẢN LÝ DANH MỤC
								</h1>
								<ul
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content" style="background: linear-gradient(135deg, #dbeafe, #818cf8);">
        ...
        <div id="kt_content_container" class="container">
            <div class="card shadow-lg rounded-4 border-0" >
                <div class="card-header text-white d-flex justify-content-between align-items-center py-3 px-4">
                    <h2 class="card-title text-uppercase fw-bold mb-0">
                        Quản Lý Danh Mục
                    </h2>
                </div>
             <div class="container mt-4">
    <div class="row">
        <!-- Card Form Nhập Danh Mục -->
        <div class="col-md-5">
            <div class="card shadow-lg rounded-4">
               
                <div class="card-body">
                    <form:form action="/admin/create" modelAttribute="categoryItem" method="post" class="row g-3" id="categoryForm">
                       

                        <!-- Mã danh mục -->
                        <div class="col-12">
                            <label class="form-label">Mã danh mục</label>
                            <form:input path="id" type="text"  placeholder="Nhập mã danh mục" class="form-control"/>
                            <form:errors path="id" class="form-text text-danger" />
                            <c:if test="${not empty error_category}">
                                <div class="form-text text-danger">
                                    <i class="bi bi-exclamation-triangle-fill me-1"></i> ${error_category}
                                </div>
                            </c:if>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <form:input path="name" type="text" placeholder="Nhập tên danh mục" class="form-control"/>
                            <form:errors path="name" class="form-text text-danger" />
                        </div>
 <!-- Thông báo thành công -->
                        <c:if test="${not empty success_category}">
                            <div class="alert alert-success" role="alert">
                                <i class="bi bi-check-circle-fill me-1"></i> ${success_category}
                            </div>
                        </c:if>
                        <!-- Nút thao tác -->
                        <div class="col-12 d-flex justify-content-end">
                            <button formaction="/admin/create" type="submit" class="btn btn-primary me-2">
                                <i class="bi bi-plus-lg"></i> Thêm mới
                            </button>
                            <button formaction="/admin/update" type="submit" class="btn btn-secondary me-2">
                        ...
                        <tbody class="text-center">
                            <c:forEach items="${categoryItems}" var="ca">
                                <tr>
                                    ...
                                    <td>${ca.name}</td>
                                    <td>
                                        <a href="/admin/edit?id=${ca.id}" class="btn btn-outline-success btn-sm me-2">
                                            <i class="bi bi-pencil-square"></i> Sửa
                                        </a>
                                        <a href="/admin/delete?id=${ca.id}" class="btn btn-outline-danger btn-sm">
