...
.filter__controls li:hover, .filter__controls li.active {
	color: #000; /* đậm hơn khi active */
}
...
.product__item {
	...
	position: relative;
	margin-bottom: 30px;
	overflow: hidden; /* để ẩn phần hover */
...
.product__item__pic {
	...
	padding-top: 100%; /* tạo tỷ lệ vuông: height = width */
	cursor: pointer;
	overflow: hidden;
}
...
.product__hover li a {
	...
	width: 40px; /* Kích thước khung tròn */
	height: 40px;
	background: white;
...
.product__hover li a:hover {
	background: #ffdddd; /* Màu nền khi hover */
}
...
.rating i.fa-star-o:before {
	content: "\f005"; /* icon sao rỗng thay bằng sao đặc nếu cần */
	color: #ccc;
}
			...
			<div id="carouselExampleIndicators" class="carousel slide mt-2"
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<a href="/shop" class="btn"><img
							src="assets/img/hero/hero-1.jpg" class="d-block w-100" alt="..."></a>
					</div>
					<div class="carousel-item">
						<a href="/shop" class="btn"><img
							src="assets/img/hero/hero-2.jpg" class="d-block w-100" alt="..."></a>
					</div>
...
<section class="container py-5 mt-5 products" style="padding: 0px 80px; border-radius: 20px;">
   ...
   <div class="countdown" style="margin-left: auto; display: flex; gap: 10px; padding: 5px; border-radius: 8px;">
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; width: 50px; height: 50px; background: white; border: 2px solid #ff5722; border-radius: 8px; text-align: center; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.1);">
						...
						<div class="product__item p-2"
							...
							<div class="product__item__pic set-bg "
								...
								style="height: 250px; background-size: cover; background-position: center;">
									...
									<span
									class="badge bg-warning text-dark position-absolute top-0 end-0">Giảm giá</span>
								...
								<ul class="product__hover"
									...
									<li><a href="#"
										...
										style="width: 35px; height: 35px;"> <i
											class="bi bi-heart-fill" style="color: red; font-size: 18px;"></i>
									</a></li>
									<li><a href="#"
										class="d-flex align-items-center justify-content-center bg-white rounded-circle shadow"
										style="width: 35px; height: 35px;"> <i
...
<script>
	...
	<section
		...
		<div style="display: flex; align-items: center; max-width: 1200px;">
			...
			<div style="flex: 1; text-align: left; padding-right: 50px;">
				<h1
					style="font-size: 50px; font-style: italic; font-weight: bold; margin: 0;">New!</h1>
			...
			<div style="display: flex; gap: 20px;">
				<div
					...
					<img
						src="https://bazaar.qodeinteractive.com/wp-content/uploads/2017/06/h2-product-1a.jpg"
				...
				<div
					style="position: relative; overflow: hidden; text-align: center;">
					<img
						src="https://bazaar.qodeinteractive.com/wp-content/uploads/2017/06/h2-product-2a.jpg"
						alt="buckled wedges"
						style="display: block; width: 200px; height: auto; transition: transform 0.3s ease-in-out; border-radius: 10px;">
	...
	<section class="product spad mt-5">
		<div class="container">
			...
			<!-- Product Carousel -->
			<div id="bestSellersCarousel" class="carousel slide"
		...
		<button class="carousel-control-prev" type="button"
			data-bs-target="#bestSellersCarousel" data-bs-slide="prev">
			<span class="carousel-control-prev-icon" aria-hidden="true"></span> <span
				class="visually-hidden">Previous</span>
		</button>
		<button class="carousel-control-next" type="button"
			data-bs-target="#bestSellersCarousel" data-bs-slide="next">
	...
	<section class="product spad">
		<!-- IMG ẢNH  -->
		<section
			style="display: flex; padding: 100px 0px; background: #f5f5f5;">
			<div
				style="display: flex; justify-content: center; align-items: center; gap: 20px;">
				<div
					style="position: relative; overflow: hidden; border-radius: 10px; cursor: pointer; width: 300px; height: auto;">
					<img src="assets/img/slide/slide-1-trang-chu-slide-1.png"
						alt="ÁO THUN"
						style="width: 100%; height: auto; transition: transform 0.4s ease-in-out;">
					<div
						style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(255, 255, 255, 0); opacity: 0; transition: opacity 0.4s ease-in-out;"></div>
				</div>

				<div
					style="position: relative; overflow: hidden; border-radius: 10px; cursor: pointer; width: 45%; height: auto;">
					<img src="assets/img/slide/slide-2-trang-chu-slide-2.png"
				...
				<div
					style="position: relative; overflow: hidden; border-radius: 10px; cursor: pointer; width: 300px; height: auto;">
					<img src="assets/img/slide/slide-4-trang-chu-slide-3.png"
						alt="SƠ MI"
						style="width: 100%; height: auto; transition: transform 0.4s ease-in-out;">
					<div
						style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(255, 255, 255, 0); opacity: 0; transition: opacity 0.4s ease-in-out;"></div>
	...
	</footer> <!-- Bootstrap 5 JS --> <script
		src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>

	<!-- Search End --> <script type="text/javascript">
	    function detail(id) {
    ...
    <!-- Js Plugins --> <script src="assets/js/jquery-3.3.1.min.js"></script>
