			...
			<div class="row justify-content-center">
				<div class="col-lg-8">
					<div class="card shadow-lg border-0 rounded-4 overflow-hidden">
						<!-- Header -->
						<div
							class="card-header bg-gradient text-center fw-bold py-3 position-relative">
						...
						<div class="card-body text-center">
							<div class="d-flex flex-column align-items-center">
								<div class="position-relative">
									...
									<div
										class="position-absolute bottom-0 end-0 bg-success rounded-circle border border-white shadow-sm"
						...
						<div class="card-body p-4">
							<form action="/account/change-password" method="post">
								...
								<div class="mb-3">
									...
									<div class="input-group">
										<span class="input-group-text"><i
											class="bi bi-key-fill"></i></span> <input name="confirm-newPass"
											type="password" class="form-control password-toggle" required>
										<button class="btn btn-outline-secondary toggle-password"
											type="button">
											<i class="bi bi-eye-slash"></i>
								...
								<button type="submit"
									class="btn w-100 text-white fw-bold py-2 mt-2"
