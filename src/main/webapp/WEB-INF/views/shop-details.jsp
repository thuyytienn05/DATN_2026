								...
								<div class="product-images">
									<div class="main-image">
										<img id="mainProductImage"
											src="<c:url value='/assets/img/product/${detailProduct[3][0]}'/>" alt=""
								...
								<div class="product-info">
									...
									<div class="product-price mt-2">
										<span class="text-danger fw-bold h3">
											<fmt:formatNumber value="${detailProduct[2]}" pattern="#,###" /> &#8363;
										</span> <span class="text-muted text-decoration-line-through ms-2">
											<fmt:formatNumber value="${detailProduct[2] * 1.3}" pattern="#,###" />
											&#8363;
									...
									<div class="product-buttons mt-4">
										<button onclick="addToCart(${detailProduct[0]})"
											class="btn btn-danger px-4 py-2"> <i class="bi bi-cart3 me-3"
												style="font-size: 20px;"></i>Thêm vào giỏ hàng</button>
							...
							<c:forEach items="${relatedProducts}" var="item">
								<div class="col">
									<div class="product__item border rounded shadow-sm p-2 product-card">
										<div class="product__item__pic position-relative" onclick="detail(${item.key})">
											<img src="<c:url value='/assets/img/product/${item.value[3][0]}'/>"
												class="img-fluid rounded" alt=""> <span
												class="badge bg-danger position-absolute top-0 start-0">-30%</span>
											<span class="badge bg-warning text-dark position-absolute top-0 end-0">Yêu
												thích</span>
											<ul class="product__hover" style="list-style: none; padding: 0; position: absolute; bottom: 10px; right: 10px; 
           display: flex; gap: 5px; opacity: 0; transition: opacity 0.3s ease-in-out;">
												...
												<li>
													<a href="#"
														class="d-flex align-items-center justify-content-center bg-white rounded-circle shadow"
														style="width: 35px; height: 35px; transition: transform 0.2s;">
														<i class="bi bi-share-fill text-primary"
				...
				<script type="text/javascript">
					...
					async function addToCart(id) {
						...
						await fetch("http://localhost:8080/shop/cart/add?id=" + id + "&qty=" + qty);
